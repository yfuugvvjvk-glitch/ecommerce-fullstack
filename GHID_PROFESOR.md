...
- **Imagini produse:** `backend/public/uploads/media/` (20 imagini)
- **Avatare:** `backend/public/uploads/avatars/`
- **Oferte:** `backend/public/uploads/offers/`

**Notă:** Toate imaginile sunt acum incluse în repository pentru evaluare.
...
*Acest proiect reprezintă munca mea pentru obținerea diplomei de licență și demonstrează competențele dobândite în dezvoltarea aplicațiilor web full-stack moderne.*
